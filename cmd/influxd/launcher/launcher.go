...
import (
	...
	"github.com/blastbao/influxdb/telemetry"
	...
	infprom "github.com/blastbao/influxdb/prometheus"
	"github.com/blastbao/influxdb/query"
	pcontrol "github.com/blastbao/influxdb/query/control"
	"github.com/blastbao/influxdb/snowflake"
	"github.com/blastbao/influxdb/source"
	"github.com/blastbao/influxdb/storage"
	"github.com/blastbao/influxdb/storage/readservice"
	"github.com/blastbao/influxdb/task"
	taskbackend "github.com/blastbao/influxdb/task/backend"
	taskbolt "github.com/blastbao/influxdb/task/backend/bolt"
	"github.com/blastbao/influxdb/task/backend/coordinator"
	taskexecutor "github.com/blastbao/influxdb/task/backend/executor"
	_ "github.com/blastbao/influxdb/tsdb/tsi1" // needed for tsi1
	_ "github.com/blastbao/influxdb/tsdb/tsm1" // needed for tsm1
	"github.com/blastbao/influxdb/vault"
	pzap "github.com/blastbao/influxdb/zap"
)
