...
import (
	...
	"github.com/blastbao/influxdb/chronograf/roles"
)
...
func setSuperAdmin(ctx context.Context, req userRequest, user *chronograf.User) error {
	...
	// TODO(desa): Refactor this https://github.com/blastbao/influxdb/chronograf/issues/2207
	if isSuperAdmin := hasSuperAdminContext(ctx); isSuperAdmin {
		...
		return fmt.Errorf("user does not have authorization required to set SuperAdmin status. See https://github.com/blastbao/influxdb/chronograf/issues/2601 for more information")
	}
