...
<p align="left">
  <img src="https://github.com/blastbao/influxdb/chronograf/blob/master/docs/images/overview-readme.png"/>
</p>
...
Chronograf's
[pre-canned dashboards](https://github.com/blastbao/influxdb/chronograf/tree/master/canned)
...
[OSS InfluxDB](https://github.com/blastbao/influxdb) and InfluxData's
...
See
[Chronograf with TLS](https://github.com/blastbao/influxdb/chronograf/blob/master/docs/tls.md)
for more information.

### OAuth Login

See
[Chronograf with OAuth 2.0](https://github.com/blastbao/influxdb/chronograf/blob/master/docs/auth.md)
for more information.
...
[an issue](https://github.com/blastbao/influxdb/chronograf/issues/new)!
...
* Chronograf requires users to run Telegraf's
  ...
  [HOST LIST](https://github.com/blastbao/influxdb/chronograf/blob/master/docs/GETTING_STARTED.md#host-list)
  page.
...
1. Build the Chronograf package:
    ```bash
    go get github.com/blastbao/influxdb/chronograf
    cd $GOPATH/src/github.com/blastbao/influxdb/chronograf
    make
    ```
1. Install the newly built Chronograf package:
    ```bash
    go install github.com/blastbao/influxdb/chronograf/cmd/chronograf
    ```
